...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ImageResponse&&(identical(other.url, url) || other.url == url));
}
...
class _ImageResponse extends ImageResponse {
  const _ImageResponse({required this.url}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ImageResponse&&(identical(other.url, url) || other.url == url));
}
